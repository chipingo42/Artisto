        ...
        <div>
          <form className='flex relative top-0 left-0 mt-4 '>
            <label htmlFor="search">
              <span>
                <FiSearch className='absolute top-3 left-3 text-[20px] ' />
              </span>
            </label>
            <input id='search' type="text" placeholder='Search' className='w-[400px] h-[46px] bg-[#1A1405] rounded-full pl-10 outline-none ' />
          </form>
        </div>
      </div>
    </div>
