...
const Detailspage = () => {
  ...
  return (
    <>
      <Navbar></Navbar>
      <div className='bg-[#110C00] w-full py-[90px] min-h-screen text-white relative top-0 left-0 '>
        <span className='absolute bottom-0'>
          <svg className='min-h-screen w-[80%]' viewBox="0 0 1001 945" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='max-w-[1200px] mx-auto '>
          ...
          <div className='flex justify-center gap-14 mt-[40px] '>
            ...
            <div className='w-[626px]'>
              ...
              <p className=' font-Sora font-[400] text-[20px] pt-[20px]'>{myData.artist_display}</p>
              <div className='flex items-center space-x-10 mt-[185px]'>
        ...
        <span className='absolute right-0 bottom-0 '>
          <img src={groupLine} alt="/" className='h-[500px]' />
        </span>
      </div>
    </>
  )
